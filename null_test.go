...
func TestToDateNull(t *testing.T) {
	result, errs := f.Calculate(`todate(NULL())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != nil {
...
func TestToDateTimeNull(t *testing.T) {
	result, errs := f.Calculate(`todatetime(NULL())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != nil {
...
func TestTrimLeftNull(t *testing.T) {
	result, errs := f.Calculate(`trimleft(NULL())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != nil {
	...
	result, errs = f.Calculate(`trimleft(' a ', null())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != `a ` {
...
func TestTrimRightNull(t *testing.T) {
	result, errs := f.Calculate(`trimright(NULL())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != nil {
	...
	result, errs = f.Calculate(`trimright(' a ', null())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != ` a` {
...
func TestUppercaseNull(t *testing.T) {
	result, errs := f.Calculate(`uppercase(NULL())`, nil)
	if len(errs) > 0 {
		t.Fatalf(`expected no errors but got: %v`, errs)
	}
	if result != nil {
